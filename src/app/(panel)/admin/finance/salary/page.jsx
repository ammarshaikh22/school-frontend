...
import { Wallet, TrendingUp, Calendar, Users } from "lucide-react";
...
export default function TeacherSalary() {
  const mockTeacherSalaries = [
    ...
    {
      name: "Ms. Sakshi Reddy",
      email: "sakshi.r@school.com",
      department: "Science",
      baseSalary: 60000,
      allowances: 10000,
      netSalary: 70000,
  ...
  const totalSalaryAmount = mockTeacherSalaries.reduce(
    (sum, t) => sum + t.netSalary,
    0,
  );
  const paidSalaries = mockTeacherSalaries.filter(
    (t) => t.status === "Paid",
  ).length;
  const pendingSalaries = mockTeacherSalaries.filter(
    (t) => t.status === "Pending",
  ).length;
  const totalAllowances = mockTeacherSalaries.reduce(
    (sum, t) => sum + t.allowances,
    0,
  );
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  Manage and track teacher salary payments
                </p>
              </div>
