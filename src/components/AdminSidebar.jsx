...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      href: '#',
      submenu: [
        { label: 'Create Announcement', href: '#' },
        { label: 'All Announcements', href: '#' },
      ],
    },
    {
      id: 'notifications',
